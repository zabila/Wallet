...
public sealed class RepositoryBase<T>(DbContext repositoryContext) : IRepositoryBase<T> where T : class
{
    ...
    public async Task CreateAsync(T entity, CancellationToken cancellation)
    {
