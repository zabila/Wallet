...
namespace Wallet.Infrastructure.Repository.Migrations
{
    ...
    [Migration("20250202212537_AddedLocalization")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wallet.Domain.Entities.Model.WalletIdentityUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Wallet.Domain.Entities.Model.WalletIdentityUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Wallet.Domain.Entities.Model.Transaction", b =>
                {
                    b.OwnsOne("Wallet.Domain.Entities.Model.Location", "Location", b1 =>
                        {
                            ...
                            b1.ToTable("Transactions", "Wallet");
